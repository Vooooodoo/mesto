//todo подправить адаптив в секции редактирования профиля и добавления карточек
//todo допилить, чтобы пустые карточки не добавлялись
//todo проверить будет ли работать лисенер, если не указывать evt.target
//todo попробовать рефакторинг кода кнопок submit/close и поля ввода на evt.target
